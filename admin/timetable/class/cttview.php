<?php
    ...
    $id=$_GET['id'];
    $result=mysqli_query($con, "SELECT * FROM ctimetable WHERE classid=$id ");
...
<html lang="en">
  ...
  background: linear-gradient(115deg, #56d8e4 10%, #9f01ea 90%);
        ...
        <h1>  Time Table of <?php echo $row['cname']; ?> </h1>

        
        <form action="ttupdate.php" method="post">
        <!-- <input type="text" name="sid" value=" <?php echo $row['classid']; ?>"> -->
