...
if(isset($_POST['ttsubmit'])){
    ...
    $stmt=$con->prepare("INSERT INTO timetable (staffid,mp1,mp2,mp3,mp4,mp5,tp1,tp2,tp3,tp4,tp5,wp1,wp2,wp3,wp4,wp5,thp1,thp2,thp3,thp4,thp5,fp1,fp2,fp3,fp4,fp5) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
